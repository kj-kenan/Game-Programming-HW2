...
namespace Controller
{
    public class ThirdPersonCamera : PlayerCamera
    {
        ...
        private void Start()
        {
            // Eğer m_Player boşsa, sahnede "Player" tag'li objeyi bul
            if (m_Player == null)
            {
                ...
                {
                    Debug.LogWarning("ThirdPersonCamera: No object with 'Player' tag found in the scene!");
                }
            }
        }
        ...
        public override void SetInput(in Vector2 delta, float scroll)
        {
            ...
            // Eğer m_Player atanmadıysa Vector3.zero kullanma → sadece atanmışsa devam et
